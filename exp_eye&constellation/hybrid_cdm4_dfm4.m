...
for t=Td+1:1:length(Tx_data)
    Rx_data(t)=Tx_data(t)^2+gamma^2*Tx_data(t-Td)^2+2*gamma*Tx_data(t)*Tx_data(t-Td)*cos(wc*Td+N_phase(t))+N_inten(t);
end
...
BER_total=BER_total';
% figure;plot(SNR,log10(BER1),'-')
% hold on;plot(SNR,log10(BER2),'-')
% hold on;plot(SNR,log10(BER3),'-')
% hold on;plot(SNR,log10(BER4),'-')
% hold on;plot(SNR,log10(BER5),'-')
% hold on;plot(SNR,log10(BER6),'-')
% hold on;plot(SNR,log10(BER7),'-')
% hold on;plot(SNR,log10(BER8),'-')
